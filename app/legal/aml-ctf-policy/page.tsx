        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                For questions regarding this AML/CTF Policy, please contact our Compliance team at <a href="mailto:partners@hmcts.co.uk">partners@hmcts.co.uk</a> or call <a href="tel:+443333355520">+44 (0)333 335 5520</a>.
              </p>
